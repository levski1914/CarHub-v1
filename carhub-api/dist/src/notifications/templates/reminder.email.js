...
exports.reminderEmailHtml = reminderEmailHtml;
function reminderEmailHtml({ title, plate, label, dueDate, daysDiff, kind, }) {
    const color = kind === 'overdue'
        ? '#dc2626'
        : daysDiff && daysDiff <= 3
            ? '#f59e0b'
            : '#16a34a';
    const badgeText = kind === 'overdue' ? 'ПРОСРОЧЕНО' : daysDiff ? `след ${daysDiff} дни` : '';
    return `
<!DOCTYPE html>
<html lang="bg">
<head>
...
//# sourceMappingURL=reminder.email.js.map