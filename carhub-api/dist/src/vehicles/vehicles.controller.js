...
let VehiclesController = class VehiclesController {
    ...
    listObligations(req, id) {
        return this.svc.listObligations(req.user.userId, id);
    }
    createObligation(req, id, body) {
        return this.svc.createObligation(req.user.userId, id, body);
    }
    upsertObligation(req, vehicleId, type, body) {
        return this.svc.upsertObligation(req.user.userId, vehicleId, type, body.dueDate);
    }
    enrich(req, id, body) {
...
__decorate([
    (0, common_1.Get)(':id/obligations'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], VehiclesController.prototype, "listObligations", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, String, Object]),
    __metadata("design:returntype", void 0)
], VehiclesController.prototype, "createObligation", null);
__decorate([
    (0, common_1.Put)(':id/obligations/:type'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", void 0)
], VehiclesController.prototype, "upsertObligation", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, String, Object]),
    __metadata("design:returntype", void 0)
], VehiclesController.prototype, "enrich", null);
