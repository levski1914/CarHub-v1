...
"[project]/src/app/(app)/vehicles/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function VehiclesPage() {
    ...
    async function load() {
        ...
        try {
            ...
            const withObligations = await Promise.all(vehicles.map(async (v)=>{
                const obs = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].listObligations(v.id).catch(()=>[]);
                const byType = {};
                for (const o of obs){
    ...
    const sorted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "VehiclesPage.useMemo[sorted]": ()=>{
            const prio = {
                "VehiclesPage.useMemo[sorted].prio": (s)=>s === "overdue" ? 0 : s === "soon" ? 1 : 2
            }["VehiclesPage.useMemo[sorted].prio"];
            return [
                ...rows
            ].sort({
                "VehiclesPage.useMemo[sorted]": (a, b)=>prio(a.vehicle.status) - prio(b.vehicle.status)
            }["VehiclesPage.useMemo[sorted]"]);
        }
    }["VehiclesPage.useMemo[sorted]"], [
        rows
    ...
    const nextDue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "VehiclesPage.useMemo[nextDue]": ()=>{
            let best = null;
            for (const r of rows){
    ...
    async function saveEdit() {
        ...
        setSaving(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].updateVehicle(editId, {
    ...
    async function deleteVehicle(v) {
        ...
        setErr("");
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].deleteVehicle(v.id);
            await load();
        } catch (e) {
            setErr(e?.message ?? "Грешка");
        }
...
_s(VehiclesPage, "/VtIpHozVDWiXhN6AQHXR/XFXZw=");
_c = VehiclesPage;
var _c;
...
//# sourceMappingURL=src_42af4596._.js.map